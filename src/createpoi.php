...
echo "
    ...
    <form class=\"container\" action=\"confirmcreate.php? method=\"post\"\">
    <br>
    <br>
    <p class=\"text-center h1\" style=\"font-weight:bold;\">CREATE YOUR POI:</p><br>
    <div  style=\"text-align: center\">
        <form>
            <iframe width=\"600\" height=\"500\" frameborder=\"0\" scrolling=\"no\" marginheight=\"0\" marginwidth=\"0\" 
            src=\"http://www.openstreetmap.org/export/embed.html?marker=" . $_GET['lat'] . "," . $_GET['lon'] ."\" style=\"border: 3px solid grey\">
            </iframe>
        </form>
    </div>
    ...
    <textarea type=\"text\" id=\"description\" class=\"form-control\" name=\"description\" rows=\"4\" cols=\"50\" required></textarea><br>
    <label for=\"lat\" style=\"font-weight:bold;\">LAT: *</label><br>
    <input type=\"text\" id=\"lat\" class=\"form-control\" name=\"lat\" placeholder=\"" . $_GET['lat'] . "\"><br>
    <label for=\"lon\" style=\"font-weight:bold;\">LON: *</label><br>
    <input type=\"text\" id=\"lon\" class=\"form-control\" name=\"lon\" placeholder=\"" . $_GET['lon'] . "\"><br>
    <label for=\"url\" style=\"font-weight:bold;\">URL:</label><br>
    <input type=\"text\" id=\"url\" class=\"form-control\" name=\"url\"><br>
