...
$datas = $mysqli->query("SELECT * FROM poi AS p INNER JOIN openingtimes AS o ON p.id = o.id;");
...
echo "
    ...
    * {box-sizing: border-box;}
    ...
    <div style=\"text-align: center\">
        ...
        <button style=\"height:80px; width:200px;\" class=\"btn btn-primary\" onclick=\"document.location='poitoiscore.php'\"><i class=\"fa fa-star\"> POI-TOI SCORE</i></button>
...
while($r = mysqli_fetch_assoc($datas)) {
    ...
    if($r['note'] == ""){
        $missing = $missing . "opening times" . "<br>";
        $c++;
    }
    if(substr($r['note'], 0, 1) == "Q"){
        $missing = $missing . "opening times" . "<br>";
        $c++;
    }
